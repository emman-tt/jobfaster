      ...
      <DragDropProvider onDragEnd={handleDragEnd}>
        ...
        {isOpen && (
          <div className='px-4 sm:px-6 md:px-8 lg:px-10 py-4 space-y-3'>
            ...
            <button
              onClick={() => openModal()}
              className={`w-full flex items-center justify-center gap-2 px-4 py-3 border border-dashed rounded-xl hover:bg-gray-50 hover:border-gray-400 cursor-pointer transition-colors text-sm ${
                appearance.theme == 'dark'
