    ...
    >
                      ...
                      >
                        <div className="flex gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3
                              className={`text-sm font-bold font-IBM truncate ${
                                appearance.theme == "dark"
                                  ? "text-white"
                                  : "text-slate-900"
                              }`}
      ...
      {selectedJob && (
        <div className="fixed  inset-0 z-40">
          ...
          <div
            className={`absolute inset-x-0 sm:inset-x-auto rounded-t-2xl
               sm:rounded-2xl top-[30%] sm:top-2 bottom-0
                sm:bottom-10 sm:h-[97%] w-full
                 max-w-xl scrollbar-none sm:right-2 shadow-2xl overflow-y-auto ${
