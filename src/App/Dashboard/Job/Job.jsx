...
export default function Job() {
  ...
  return (
    <section
      className={`w-full  h-screen overflow-y-scroll [scrollbar-width:none] flex justify-center px-4 py-2 max-sm:pb-20 sm:p-6 2xl:px-10 font-satoshi ${
        appearance.theme == "dark" ? "bg-[#202020]" : "bg-white"
      }`}
    >
      <div
        className={`w-full max-w-3xl 2xl:max-w-4xl h-max my-0 sm:my-10 2xl:my-14 p-4 sm:p-10 2xl:p-14 space-y-6 sm:space-y-8 2xl:space-y-10 rounded-3xl shadow-xs ${
      ...
      >
        ...
        <div className="space-y-2">
          <h1
            className={`text-2xl 2xl:text-3xl font-bold font-IBM flex items-center gap-3 ${
          ...
          <p
            className={`text-sm 2xl:text-base ml-1 ${
        ...
        <form onSubmit={handleSubmit} className="space-y-6 2xl:space-y-10">
          ...
          <div className="flex flex-col sm:flex-row w-full gap-5 2xl:gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 2xl:gap-6">
              <li
