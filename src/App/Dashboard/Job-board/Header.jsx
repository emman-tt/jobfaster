...
export default function Header() {
  ...
  return (
    <div className="w-full bg-white px-8 pt-8 pb-5 border-b border-gray-200">
      <div className="flex items-center justify-between mb-2">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 leading-tight">Jobs</h1>
          <p className="text-sm text-gray-400 mt-0.5">Keep track of your applied job all in one place</p>
        </div>
