...
export default function JobBoardDetail({
  ...
  return (
    <div
      className={`w-full h-full flex flex-col transition-all duration-200 ${isDark ? "bg-[#2a2a2a] text-white" : " text-slate-900"}`}
    >
      {/* Grip bar for mobile */}
      <div className="h-6 left-0 right-0 bg-inherit sticky top-0 w-full sm:hidden z-10 flex items-center justify-center">
        <div
          className={`w-8 h-1 rounded-full ${isDark ? "bg-zinc-700" : "bg-slate-300"}`}
        />
      </div>
      ...
      <div className="flex-1 overflow-y-auto min-h-100">
        ...
        <div className="p-6 pb-4 pt-2 sm:pt-6">
          <div className="flex gap-4 items-start">
            <div
              className={`w-16 h-16 shrink-0 rounded-xl flex items-center justify-center overflow-hidden border ${
                isDark
            ...
            >
              {job.employerLogo ? (
                ...
                <span
                  className={`text-2xl font-bold ${isDark ? "text-zinc-500" : "text-gray-400"}`}
                >
                  {job.employerName?.[0]}
                </span>
              )}
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="flex gap-2 items-center pl-3">
                <Building2
                  className={`w-3.5 h-3.5 ${isDark ? "text-zinc-500" : "text-gray-400"}`}
                />
                <input
                  name="employerName"
        ...
        <div className="px-6 grid grid-cols-1 sm:grid-cols-2 gap-3 pb-4">
          <div className="flex items-center gap-2 pl-3">
            <MapPin
              className={`w-4 h-4 ${isDark ? "text-zinc-500" : "text-gray-400"}`}
            />
            <input
              name="jobLocation"
        ...
        <div className="px-6 pb-4">
          <p
            className={`text-xs font-semibold uppercase tracking-wider ml-4 mb-2 ${
          ...
          <textarea
            ...
            onChange={handleChange}
            className={`w-full min-h-100 resize-y leading-relaxed ${inputClass()}`}
      ...
      <div
        className={`shrink-0 p-6 pt-4 flex sm:flex-row gap-3 border-t sm:border-t-0 ${
      ...
      >
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-xs font-bold transition-all active:scale-[0.98] border border-rose-100 text-rose-500 hover:bg-rose-50 ${
            isDark
              ? "border-rose-950/30 text-rose-400 hover:bg-rose-900/20"
              : ""
          }`}
        >
