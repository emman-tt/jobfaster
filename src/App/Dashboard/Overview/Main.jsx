              ...
              <div className="flex gap-3 shrink-0">
                {!openedFolder && (
                  <button
                    ...
                    className="text-xs font-satoshi flex gap-2 shadow-sm 
                    shadow-black/40 bg-orange-400 
                      px-5
                      sm:px-4 cursor-pointer py-3 text-white items-center
                       justify-center h-full rounded-xl transition-all"
                  >
                ...
                <button
                  ...
                  className="text-xs font-satoshi flex gap-2 
                  shadow-sm shadow-black/40 bg-orange-400 
                   px-5 sm:px-4 cursor-pointer py-3 text-white
                    items-center justify-center h-full rounded-xl transition-all"
                >
