...
export default function Billings() {
  ...
  function handleUpgrade(plan) {
    if (plan.variantId === currentPlanVariantId) return;
    setPendingPlan(plan);
  ...
  function confirmUpgrade() {
    ...
    mutation.mutate(pendingPlan.variantId);
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                >
                  ...
                  <span className="font-semibold text-[#f17e27]">
            ...
            >
              ...
              >
                {pendingPlan.priceMonthly > 0
                  ? "You will be charged immediately and your new plan will take effect right away."
                  : "Your subscription will be downgraded and some features may become unavailable."}
              </p>
              <p
                className={
                  appearance.theme === "dark"
              ...
              >
                Any remaining credits or time on your current plan will be
                forfeited.
              </p>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 py-3 bg-[#f17e27] hover:bg-[#e16d16] text-white text-sm font-bold rounded-2xl transition-all flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {mutation.isPending ? (
                  <>
                    <Loader2 size={14} className="animate-spin" />
