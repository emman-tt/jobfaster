    ...
    >
      {data?.pageNumber > 1 && (
        <div style={{ marginBottom: '12px' }}>
          <div style={{ borderTop: `2px solid ${accentBlue}`, marginBottom: '6px' }} />
          ...
          <div style={{ borderTop: `2px solid ${accentBlue}`, marginTop: '6px' }} />
        </div>
      )}
          ...
          {data.projects.map(proj => (
            <div key={proj.id} data-section="projects" style={{ marginBottom: '14px' }}>
              ...
              {proj.techStack?.length > 0 && (
                ...
                >
                  <span style={{ fontWeight: 600, fontStyle: 'normal' }}>Technologies:</span> {proj.techStack.join(', ')}
                </p>
              )}
            </div>
          ))}
        ...
        <div>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              {data.education.map(edu => (
                <div key={edu.id} data-section="education" style={{ marginBottom: '10px' }}>
                  ...
                  <div style={{ fontSize: `${bodyStyles.size || 9.5}pt`, color: '#374151', margin: '2px 0' }}>
                    {edu.school}
                  </div>
                  ...
                  {edu.highlights?.length > 0 && (
                    <div style={{ fontSize: `${bodyStyles.size || 9}pt`, color: '#6B7280', marginTop: '2px' }}>
                      {edu.highlights.join(' • ')}
                    </div>
                  )}
                </div>
          ...
          {data?.languages?.length > 0 && (
            <div>
              ...
              <div style={{ fontSize: `${bodyStyles.size || 9.5}pt`, lineHeight: 1.6 }}>
