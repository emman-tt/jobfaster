    ...
    >
      {data?.pageNumber > 1 && (
        <div style={{ marginBottom: '12px' }}>
          <div style={{ borderTop: `1px solid ${primaryColor}`, marginBottom: '6px' }} />
          ...
          <div style={{ borderTop: `1px solid ${primaryColor}`, marginTop: '6px' }} />
        </div>
      )}
          ...
          {data.experience.map((exp, expIndex) => (
            <div
              ...
              style={{
                marginBottom: '16px',
                paddingLeft: '16px',
                borderLeft: expIndex < data.experience.length - 1 ? '2px solid #e2e8f0' : 'none',
              }}
            >
              <div
                style={{
      ...
      {(data?.education?.length > 0 || data?.skills?.length > 0 || data?.certificates?.length > 0) && (
              ...
              <>
                ...
                {data.education.map(edu => (
                  <div key={edu.id} data-section="education" style={{ marginBottom: '10px' }}>
                    ...
                    <div style={{ fontSize: `${bodyStyles.size || 9.5}pt`, color: '#64748b', margin: '2px 0' }}>
