    ...
    >
      {data?.pageNumber > 1 && (
        <div style={{ marginBottom: '12px' }}>
          <div style={{ borderTop: `1px solid ${accentColor}`, marginBottom: '6px' }} />
          ...
          <div style={{ borderTop: `1px solid ${accentColor}`, marginTop: '6px' }} />
        </div>
      )}
      ...
      >
        ...
        >
          ...
          {links?.map((item, index) => (
            <span key={item.name} style={{ color: accentColor, fontWeight: 500 }}>
              🔗 {item.link}
            </span>
          ))}
        </div>
      ...
      {data?.skills?.length > 0 && (
        <div style={{ marginBottom: '20px' }}>
          ...
          >
            <span style={{ background: accentColor, width: '20px', height: '3px', marginRight: '10px' }} />
            Skills & Technologies
          </h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
        <div>
          {data?.education?.length > 0 && (
            <div>
              ...
              >
                <span style={{ background: accentColor, width: '16px', height: '3px', marginRight: '8px' }} />
                Education
              </h2>
              {data.education.map(edu => (
                <div key={edu.id} data-section="education" style={{ marginBottom: '10px' }}>
                  <div style={{ fontWeight: 'bold', fontSize: `${companyStyles.size || 10.5}pt`, margin: '0' }}>
                    {edu.degree} {edu.field && `in ${edu.field}`}
                  </div>
                  <div style={{ fontSize: `${bodyStyles.size || 9.5}pt`, color: '#6B7280', margin: '2px 0' }}>
        ...
        <div>
          ...
          {data?.languages?.length > 0 && (
            <div style={{ marginBottom: data?.certificates?.length > 0 ? '20px' : 0 }}>
              <h2
                style={{
                  fontSize: `${sectionStyles.size || 10.5}pt`,
                  fontWeight: 'bold',
