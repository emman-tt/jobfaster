export const essentialGapQuestions = [
  {
    id: 1,
    gap: "Missing metrics",
    question: "Can you add numbers to any achievements? (%, $, time saved, people managed)",
  ...
  },
  {
    ...
    question: "What specific RESULTS did you deliver? (not just responsibilities)",
  ...
  },
  {
    ...
    question: "Replace passive phrases with stronger verbs? (led, created, improved, designed)",
